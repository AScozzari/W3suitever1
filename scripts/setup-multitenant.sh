...
echo "   • http://localhost:5000/staging (Development)"
echo "   • http://localhost:5000/demo    (Showcase)" 
echo "   • http://localhost:5000/acme    (Enterprise)"
echo "   • http://localhost:5000/tech    (Solutions)"
echo ""
