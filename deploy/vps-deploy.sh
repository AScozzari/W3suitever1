...
echo "   Current value: 80 (80% zoom, like browser zoom)"
echo ""
echo "🎨 To deploy frontend separately:"
echo "   cd apps/frontend/web && VITE_FONT_SCALE=80 npx vite build"
echo "   scp -r dist/* $VPS_HOST:$VPS_PATH/apps/frontend/web/dist/"
echo ""
echo "⚠️  IMPORTANT: Always set VITE_FONT_SCALE=80 when building frontend!"
