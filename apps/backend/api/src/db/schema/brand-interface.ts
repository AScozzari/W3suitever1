...
// Used by ai-settings.ts to fetch agents from Brand Interface without dynamic imports

export const agentModuleContextEnum = pgEnum("agent_module_context", [
...
export type InsertAIAgentRegistry = z.infer<typeof insertAIAgentRegistrySchema>;