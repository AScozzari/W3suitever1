  ...
  async destroyTenantKeys(
    ...
    try {
      ...
      const auditLogPre: InsertStructuredLog = {
        tenantId,
        level: 'ERROR',
        message: 'GDPR Key destruction initiated - AUDIT TRAIL',
      ...
      const auditLogPost: InsertStructuredLog = {
        tenantId,
        level: 'ERROR',
        message: 'GDPR Key destruction completed - COMPLIANCE AUDIT',
      ...
      const auditLogFailed: InsertStructuredLog = {
        tenantId,
        level: 'ERROR',
        message: 'GDPR Key destruction FAILED - AUDIT TRAIL',
        component: 'encryption-gdpr-audit',
