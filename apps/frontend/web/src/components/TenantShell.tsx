...
const TenantRoutes: React.FC<{ tenantSlug: string }> = ({ tenantSlug }) => {
  ...
  return (
    <Suspense fallback={<PageLoader />}>
      ...
      <Route path={`/${tenantSlug}/hr/tasks`}>
        <AuthenticatedRoute>
          <TaskManagementPage />
        </AuthenticatedRoute>
      </Route>
      ...
      {/* 🎯 CRM CAMPAIGN LEADS - Route specifica per visualizzazione lead campagna */}
      <Route path={`/${tenantSlug}/crm/campaigns/:id/leads`}>
        <AuthenticatedRoute>
          <CampaignLeadsPage />
        </AuthenticatedRoute>
      </Route>
      ...
      {/* 📦 WMS - Inventory Page (standalone full-featured inventory view) */}
      <Route path={`/${tenantSlug}/magazzino/inventario`}>
        <AuthenticatedRoute>
          <InventoryPage />
        </AuthenticatedRoute>
      </Route>
      
      <Route path={`/${tenantSlug}/magazzino`}>
        <AuthenticatedRoute>
          <WMSDashboardPage />
        </AuthenticatedRoute>
      </Route>
