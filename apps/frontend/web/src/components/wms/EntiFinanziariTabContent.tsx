...
import { 
  Plus, Landmark, Eye, Trash2, RefreshCw, AlertCircle, X, Search, CalendarIcon, Building2
} from 'lucide-react';
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            ...
            <tbody>
              {filteredEntities.map((entity: any, index: number) => (
                <tr
                  key={entity.id}
                  data-testid={`row-financial-entity-${entity.id}`}
                  style={{
                  ...
                  <td style={{ padding: '16px' }}>
                    <span style={{
                      ...
                      color: entity.status === 'active'
                        ...
                        ? '#dc2626'
                        : '#475569',
                      border: `1px solid ${entity.status === 'active'
                        ? '#bbf7d0' 
                        : entity.status === 'suspended'
                        ? '#fcd34d'
                        : entity.status === 'blocked'
                    ...
                    <div style={{ display: 'flex', gap: '8px', justifyContent: 'center' }}>
                      <button
                        ...
                        onClick={() => setModalState({ 
                          isOpen: true, 
                          mode: entity.origin === 'brand' ? 'view' : 'edit', 
                          data: entity 
                        })}
                        style={{
                ...
                <tr>
                  <td colSpan={7} style={{ 
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px' }}>
                      ...
                      <div>Nessun ente finanziario configurato</div>
