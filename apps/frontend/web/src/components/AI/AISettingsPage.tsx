                ...
                <div className="flex items-center space-x-3">
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[#FF6900] focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed ${
                      !formData.isActive ? 'bg-gray-200' : (agent.isEnabled !== undefined ? agent.isEnabled : agent.status === 'active') ? 'bg-[#FF6900]' : 'bg-gray-300'
                    }`}
                  ...
                  >
                    <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                      !formData.isActive ? 'translate-x-1' : (agent.isEnabled !== undefined ? agent.isEnabled : agent.status === 'active') ? 'translate-x-6' : 'translate-x-1'
                    }`} />
                  </button>
