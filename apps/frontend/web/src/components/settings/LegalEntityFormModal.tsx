    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <h4 style={{ ...formStyles.sectionTitle, marginTop: '24px' }}><Briefcase size={16} /> Dati Societari</h4>
          <div style={formStyles.grid(2)}>
            <div>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <h4 style={{ ...formStyles.sectionTitle, marginTop: '24px' }}><Phone size={16} /> Contatti Aziendali</h4>
          <div style={formStyles.grid(2)}>
            <div>
          ...
          <div style={formStyles.grid(2)}>
            ...
            <div>
              ...
              <StandardEmailField
                ...
                onChange={(val) => setFormData({ ...formData, refAmminEmail: val })}
              />
            </div>
            <div>
              <label style={formStyles.label}>Codice Fiscale</label>
