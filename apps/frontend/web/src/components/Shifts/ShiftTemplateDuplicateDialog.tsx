...
import { Plus, Trash2, Clock, Copy, Save, Store as StoreIcon, Loader2 } from 'lucide-react';
...
interface ShiftTemplateDuplicateDialogProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function ShiftTemplateDuplicateDialog({ isOpen, onClose, templateId }: ShiftTemplateDuplicateDialogProps) {
    ...
    return (
      <Form {...form}>
        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="es. Turno Mattina (Copia)" {...field} data-testid="input-duplicate-template-name" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <Select onValueChange={field.onChange} value={field.value}>
                            <FormControl>
                              <SelectTrigger data-testid="select-duplicate-store">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea placeholder="Descrizione del template..." {...field} data-testid="input-duplicate-description" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                        ...
                        <div className="flex gap-2">
                          {TEMPLATE_COLORS.map((color) => (
                            <button
                              ...
                              title={color.name}
                              data-testid={`duplicate-color-${color.name.toLowerCase().replace(' ', '-')}`}
                            />
                          ))}
                        </div>
                        <FormMessage />
                        ...
                        <FormControl>
                          <RadioGroup onValueChange={field.onChange} value={field.value} className="grid grid-cols-2 gap-4">
                            <div className={`flex items-center space-x-2 p-4 rounded-lg border-2 cursor-pointer transition-all ${field.value === 'slot_based' ? 'border-orange-500 bg-orange-50' : 'border-gray-200 hover:border-gray-300'}`}>
                              <RadioGroupItem value="slot_based" id="duplicate-slot_based" />
                              <label htmlFor="duplicate-slot_based" className="cursor-pointer">
                            ...
                            <div className={`flex items-center space-x-2 p-4 rounded-lg border-2 cursor-pointer transition-all ${field.value === 'split_shift' ? 'border-orange-500 bg-orange-50' : 'border-gray-200 hover:border-gray-300'}`}>
                              <RadioGroupItem value="split_shift" id="duplicate-split_shift" />
                              <label htmlFor="duplicate-split_shift" className="cursor-pointer">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input type="number" {...field} onChange={e => field.onChange(parseInt(e.target.value) || 0)} data-testid="duplicate-input-clock-in-tolerance" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input type="number" {...field} onChange={e => field.onChange(parseInt(e.target.value) || 0)} data-testid="duplicate-input-clock-out-tolerance" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input type="number" {...field} onChange={e => field.onChange(parseInt(e.target.value) || 0)} data-testid="duplicate-input-break-minutes" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
              ...
              <Card>
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Button type="button" variant="outline" size="sm" onClick={addTimeSlot} disabled={fields.length >= 5} data-testid="button-duplicate-add-timeslot">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {[1, 2, 3, 4].map((count) => (
                            <button
                              ...
                              data-testid={`duplicate-button-block-count-${index}-${count}`}
                            >
                              {count}
                            </button>
                          ))}
                          {fields.length > 1 && (
                            <Button type="button" variant="ghost" size="sm" onClick={() => removeTimeSlot(index)} className="text-red-500 hover:text-red-700" data-testid={`button-duplicate-remove-timeslot-${index}`}>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input type="time" {...field} data-testid={`duplicate-input-start-time-${index}`} />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input type="time" {...field} data-testid={`duplicate-input-end-time-${index}`} />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input type="time" {...field} value={field.value || ''} data-testid={`duplicate-input-block2-start-${index}`} />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                            )}
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input type="time" {...field} value={field.value || ''} data-testid={`duplicate-input-block2-end-${index}`} />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                            )}
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input type="time" {...field} value={field.value || ''} data-testid={`duplicate-input-block3-start-${index}`} />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                            )}
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input type="time" {...field} value={field.value || ''} data-testid={`duplicate-input-block3-end-${index}`} />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                            )}
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input type="time" {...field} value={field.value || ''} data-testid={`duplicate-input-block4-start-${index}`} />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                            )}
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input type="time" {...field} value={field.value || ''} data-testid={`duplicate-input-block4-end-${index}`} />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                            )}
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                <FormLabel>Pausa (min)</FormLabel>
                                <FormControl>
                                  <Input type="number" {...field} onChange={e => field.onChange(parseInt(e.target.value) || 0)} data-testid={`duplicate-input-break-${index}`} />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                            )}
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input type="number" {...field} onChange={e => field.onChange(parseInt(e.target.value) || 0)} data-testid={`duplicate-input-clock-in-${index}`} />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                            )}
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input type="number" {...field} onChange={e => field.onChange(parseInt(e.target.value) || 0)} data-testid={`duplicate-input-clock-out-${index}`} />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                            )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea placeholder="Note aggiuntive..." {...field} data-testid="input-duplicate-notes" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
          ...
          <DialogFooter>
            <Button type="button" variant="outline" onClick={handleClose} data-testid="button-cancel-duplicate">
              Annulla
            </Button>
            <Button type="submit" disabled={duplicateMutation.isPending} data-testid="button-save-duplicate">
  ...
  }, [form, fields, shiftType, templateLoading, duplicateMutation.isPending, handleSubmit, handleClose, addTimeSlot, removeTimeSlot, getBlockCount, setBlockCount, stores]);

  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && handleClose()}>
      <DialogContent className="max-w-4xl max-h-[90vh]" data-testid="dialog-duplicate-template">
        <DialogHeader>
          ...
          <DialogDescription>
            Crea una copia del template turni selezionato
          </DialogDescription>
        </DialogHeader>
        {dialogContent}
      </DialogContent>
