...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-orange-50 to-purple-50 dark:from-gray-950 dark:via-orange-950 dark:to-purple-950 flex items-center justify-center p-4">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 glass rounded-lg border border-white/20 bg-white/10 text-gray-900 dark:text-gray-100 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500/50 transition-all duration-300"
                />
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-3 bg-transparent text-gray-500">oppure</span>
              </div>
            </div>

            <button
              onClick={handleLogin}
              className="w-full glass border border-white/20 text-gray-700 dark:text-gray-300 py-3 px-6 rounded-lg font-medium hover:bg-white/10 transition-all duration-300 flex items-center justify-center space-x-2"
            >
