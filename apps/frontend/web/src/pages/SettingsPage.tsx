...
export default function SettingsPage() {
  ...
  // Fetch dei dati del tenant corrente
  ...
  // Mock data per il tenant corrente
  const tenantInfo = {
    id: 'current-tenant',
                  ...
                  <Card key={role} className="bg-gradient-to-br from-blue-500/20 to-blue-600/20 border-blue-400/30">
                    <CardContent className="p-4">
                      ...
                      <p className="text-blue-200/70 text-sm mb-3">
                        Permessi configurati per il ruolo {role.toLowerCase()}.
                      </p>
        ...
        <div className="backdrop-blur-xl bg-white/10 rounded-2xl border border-white/20 p-6 shadow-2xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold bg-gradient-to-r from-white via-orange-200 to-white bg-clip-text text-transparent">
