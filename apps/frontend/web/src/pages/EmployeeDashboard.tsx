...
export default function EmployeeDashboard() {
  ...
  // Real data queries with hierarchical cache keys
              ...
              <div className="space-y-6" data-testid="section-profile">
                ...
                <Card className="glass-card">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Configurazione completa profilo, preferenze, sicurezza e privacy
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <Tabs defaultValue="personal" className="w-full">
                      <TabsList className="grid w-full grid-cols-5" data-testid="tabs-profile">
                        <TabsTrigger value="personal" data-testid="tab-profile-personal">
                          <User className="h-4 w-4 mr-2" />
                          Personal Info
                        </TabsTrigger>
                        <TabsTrigger value="preferences" data-testid="tab-profile-preferences">
                        ...
                        <TabsTrigger value="notifications" data-testid="tab-profile-notifications">
                          <Bell className="h-4 w-4 mr-2" />
                          Notifications
                        </TabsTrigger>
                        <TabsTrigger value="privacy" data-testid="tab-profile-privacy">
                          <Shield className="h-4 w-4 mr-2" />
                          Privacy
                        </TabsTrigger>
                      </TabsList>
                      ...
                      <TabsContent value="personal" className="space-y-6">
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                          {/* Avatar & Basic Info */}
                          <Card className="p-6">
                            <h3 className="font-semibold mb-4">Foto Profilo</h3>
                            <div className="flex flex-col items-center space-y-4">
                              <div className="relative">
                                <div className="w-24 h-24 bg-gradient-to-br from-orange-500 to-purple-600 rounded-full flex items-center justify-center text-white text-2xl font-bold">
                                  MC
                                </div>
                                <Button size="sm" className="absolute -bottom-2 -right-2 w-8 h-8 rounded-full p-0" data-testid="button-edit-avatar">
                                  <Camera className="h-4 w-4" />
                                </Button>
                              </div>
                              <div className="text-center">
                                <p className="font-medium" data-testid="text-user-name">Mario Celeste</p>
                                <p className="text-sm text-gray-600" data-testid="text-user-role">Sales Representative</p>
                                <p className="text-sm text-gray-500" data-testid="text-user-id">ID: W3-001234</p>
                              </div>
                          ...
                          <Card className="lg:col-span-2 p-6">
                            <div className="flex items-center justify-between mb-6">
                              ...
                              <Button size="sm" variant="outline" data-testid="button-edit-personal-info">
                                <Edit3 className="h-4 w-4 mr-2" />
                                Modifica
                              </Button>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              <div className="space-y-4">
                                <div>
                                  ...
                                  <Input value="Mario" disabled className="mt-1" data-testid="input-first-name" />
                                </div>
                                <div>
                                  <Label className="text-sm font-medium text-gray-700">Cognome</Label>
                                  <Input value="Celeste" disabled className="mt-1" data-testid="input-last-name" />
                                </div>
                                <div>
                                  <Label className="text-sm font-medium text-gray-700">Email Aziendale</Label>
                                  <Input value="mario.celeste@windtre.it" disabled className="mt-1" data-testid="input-work-email" />
                                </div>
                                <div>
                                  <Label className="text-sm font-medium text-gray-700">Telefono Aziendale</Label>
                                  <Input value="+39 392 123 4567" disabled className="mt-1" data-testid="input-work-phone" />
                                </div>
                              </div>
                              ...
                              <div className="space-y-4">
                                <div>
                                  ...
                                  <Input value="15/03/1985" disabled className="mt-1" data-testid="input-birth-date" />
                                </div>
                                <div>
                                  <Label className="text-sm font-medium text-gray-700">Codice Fiscale</Label>
                                  <Input value="CLSMRA85C15H501X" disabled className="mt-1" data-testid="input-tax-code" />
                                </div>
                                <div>
                                  <Label className="text-sm font-medium text-gray-700">Indirizzo</Label>
                                  <Input value="Via Roma 123, Milano (MI)" disabled className="mt-1" data-testid="input-address" />
                                </div>
                                <div>
                                  <Label className="text-sm font-medium text-gray-700">CAP</Label>
                                  <Input value="20121" disabled className="mt-1" data-testid="input-zip-code" />
                                </div>
                              </div>
                            </div>
                          </Card>
                        ...
                        <Card className="p-6">
                          <div className="flex items-center justify-between mb-6">
                            <h3 className="font-semibold">Contatti di Emergenza</h3>
                            <Button size="sm" className="bg-gradient-to-r from-orange-500 to-purple-600" data-testid="button-add-emergency-contact">
                              <Plus className="h-4 w-4 mr-2" />
                              Aggiungi Contatto
                            </Button>
                          </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {[
                              { nome: 'Giulia Celeste', relazione: 'Coniuge', telefono: '+39 392 987 6543', email: 'giulia.celeste@gmail.com' },
                              { nome: 'Franco Celeste', relazione: 'Padre', telefono: '+39 392 111 2233', email: 'franco.celeste@email.it' }
                            ].map((contact, index) => (
                              <div key={index} className="p-4 border rounded-lg bg-gray-50" data-testid={`item-emergency-contact-${index}`}>
                                <div className="flex items-start justify-between mb-3">
                                  <div>
                                    <h4 className="font-medium">{contact.nome}</h4>
                                    <p className="text-sm text-gray-600">{contact.relazione}</p>
                                  </div>
                                  <div className="flex gap-1">
                                    <Button size="sm" variant="ghost" data-testid={`button-edit-contact-${index}`}>
                                      <Edit3 className="h-3 w-3" />
                                    </Button>
                                    <Button size="sm" variant="ghost" className="text-red-600" data-testid={`button-delete-contact-${index}`}>
                      ...
                      <TabsContent value="preferences" className="space-y-6">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                          ...
                          <Card className="p-6">
                            <h3 className="font-semibold mb-4">Preferenze Interfaccia</h3>
                            <div className="space-y-6">
                              <div className="space-y-2">
                              ...
                              <div className="flex items-center justify-between">
                                <div>
                                  <Label className="text-sm font-medium">Animazioni Ridotte</Label>
                                  <p className="text-xs text-gray-500">Disattiva animazioni per migliorare le performance</p>
                                </div>
                                <Switch data-testid="switch-reduced-animations" />
                              </div>
                              
                              <div className="flex items-center justify-between">
                                <div>
                                  <Label className="text-sm font-medium">Salvataggio Automatico</Label>
                                  <p className="text-xs text-gray-500">Salva automaticamente le modifiche</p>
                                </div>
                          ...
                          {/* Work Preferences */}
                          <Card className="p-6">
                            <h3 className="font-semibold mb-4">Preferenze Lavorative</h3>
                            <div className="space-y-6">
                              <div className="space-y-2">
                                <Label className="text-sm font-medium">Modalità Lavoro Preferita</Label>
                              ...
                              <div className="space-y-2">
                                <Label className="text-sm font-medium">Orario Preferito Riunioni</Label>
                                <Select defaultValue="morning">
                                  <SelectTrigger data-testid="select-meeting-time">
                                    <SelectValue />
                                  </SelectTrigger>
                                  <SelectContent>
                                    <SelectItem value="early">Mattino Presto (8:00-10:00)</SelectItem>
                                    <SelectItem value="morning">Mattina (10:00-12:00)</SelectItem>
                                    <SelectItem value="afternoon">Pomeriggio (14:00-16:00)</SelectItem>
                                    <SelectItem value="late">Pomeriggio Tardi (16:00-18:00)</SelectItem>
                                  </SelectContent>
                                </Select>
                              </div>
                              
                              <div className="space-y-2">
                                <Label className="text-sm font-medium">Dashboard Iniziale</Label>
                                <Select defaultValue="overview">
                                  ...
                                  <SelectContent>
                                    ...
                                    <SelectItem value="timesheet">Time & Attendance</SelectItem>
                              ...
                              <div className="flex items-center justify-between">
                                <div>
                                  <Label className="text-sm font-medium">Notifiche Desktop</Label>
                                  <p className="text-xs text-gray-500">Ricevi notifiche desktop per aggiornamenti importanti</p>
                                </div>
                              ...
                              <div className="flex items-center justify-between">
                                <div>
                                  ...
                                  <p className="text-xs text-gray-500">Promemoria per scadenze e appuntamenti</p>
                                </div>
                                <Switch defaultChecked data-testid="switch-auto-reminders" />
                              </div>
                            </div>
                          </Card>
                        </div>
                        ...
                        <Card className="p-6">
                          <h3 className="font-semibold mb-4">Integrazioni e Connessioni</h3>
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {[
                              { nome: 'Outlook Calendar', descrizione: 'Sincronizza eventi calendario', connesso: true, icona: CalendarIcon },
                              { nome: 'Slack', descrizione: 'Notifiche team e messaggi', connesso: true, icona: MessageSquare },
                              { nome: 'Google Drive', descrizione: 'Accesso documenti cloud', connesso: false, icona: FileText },
                              { nome: 'LinkedIn Learning', descrizione: 'Corsi formazione esterni', connesso: true, icona: GraduationCap },
                              { nome: 'Microsoft Teams', descrizione: 'Video conferenze e chat', connesso: false, icona: Users2 },
                              { nome: 'Salesforce', descrizione: 'CRM e gestione clienti', connesso: true, icona: Briefcase }
                            ].map((integration, index) => (
                              <div key={index} className="p-4 border rounded-lg" data-testid={`item-integration-${index}`}>
                                <div className="flex items-start justify-between mb-3">
                                  <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 bg-gray-100 rounded-lg flex items-center justify-center">
                                      <integration.icona className="h-4 w-4 text-gray-600" />
                                    </div>
                                    <div>
                                      <h4 className="font-medium text-sm">{integration.nome}</h4>
                                      <p className="text-xs text-gray-500">{integration.descrizione}</p>
                                    </div>
                                  </div>
                                  <Badge variant={integration.connesso ? 'default' : 'secondary'} className="text-xs">
                                    {integration.connesso ? 'Connesso' : 'Non Connesso'}
                                  </Badge>
                                </div>
                                <Button 
                                  size="sm" 
                                  variant={integration.connesso ? 'outline' : 'default'} 
                                  className="w-full" 
                                  data-testid={`button-integration-${index}`}
                                >
                                  {integration.connesso ? 'Disconnetti' : 'Connetti'}
                                </Button>
                              </div>
                            ))}
                          </div>
                      ...
                      <TabsContent value="security" className="space-y-6">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                          ...
                          <Card className="p-6">
                            <h3 className="font-semibold mb-4">Password e Autenticazione</h3>
                            <div className="space-y-6">
                              <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                                <div className="flex items-center gap-2 mb-2">
                                  <CheckCircle className="h-4 w-4 text-green-600" />
                                  <span className="text-sm font-medium text-green-800">Password Sicura</span>
                                </div>
                                <p className="text-xs text-green-700">Ultima modifica: 15 giorni fa</p>
                              </div>
                              ...
                              <div className="space-y-4">
                                <div className="flex items-center justify-between">
                                  <div>
                                    <Label className="text-sm font-medium">Autenticazione a Due Fattori (2FA)</Label>
                                    <p className="text-xs text-gray-500">Aggiungi un livello di sicurezza extra</p>
                                  </div>
                                ...
                                <div className="flex items-center justify-between">
                                  <div>
                                    <Label className="text-sm font-medium">Login con Biometria</Label>
                                    <p className="text-xs text-gray-500">Usa impronte digitali su dispositivi supportati</p>
                                  </div>
                                ...
                                <div className="flex items-center justify-between">
                                  <div>
                                    <Label className="text-sm font-medium">Logout Automatico</Label>
                                    <p className="text-xs text-gray-500">Disconnetti dopo 30 minuti di inattività</p>
                                  </div>
                          ...
                          {/* Security Status */}
                          <Card className="p-6">
                            <h3 className="font-semibold mb-4">Stato Sicurezza</h3>
                            <div className="space-y-4">
                              <div className="text-center p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-lg">
                                <div className="text-2xl font-bold text-green-800 mb-1" data-testid="text-security-score">92%</div>
                                <p className="text-sm text-green-700">Security Score</p>
                              </div>
                              
                              <div className="space-y-3">
                                {[
                                  { check: 'Password forte', status: true },
                                  { check: '2FA attivo', status: true },
                                  { check: 'Email verificata', status: true },
                                  { check: 'Dispositivi verificati', status: true },
                                  { check: 'Backup codes generati', status: false }
                                ].map((item, index) => (
                                  <div key={index} className="flex items-center justify-between" data-testid={`item-security-check-${index}`}>
                              ...
                              <Button variant="outline" className="w-full" data-testid="button-generate-backup-codes">
                                <Shield className="h-4 w-4 mr-2" />
                                Genera Backup Codes
                              </Button>
                            </div>
                        ...
                        <Card className="p-6">
                          <div className="flex items-center justify-between mb-6">
                            <h3 className="font-semibold">Cronologia Accessi</h3>
                            <Button size="sm" variant="outline" data-testid="button-view-full-history">
                          ...
                          <div className="space-y-3">
                            {[
                              { data: '19 Dec 2024, 08:45', dispositivo: 'Chrome - Windows', luogo: 'Milano, IT', status: 'success' },
                              { data: '18 Dec 2024, 17:30', dispositivo: 'Safari - iPhone', luogo: 'Milano, IT', status: 'success' },
                              { data: '18 Dec 2024, 09:15', dispositivo: 'Chrome - Windows', luogo: 'Milano, IT', status: 'success' },
                              { data: '17 Dec 2024, 22:45', dispositivo: 'Unknown - Linux', luogo: 'Roma, IT', status: 'failed' }
                            ].map((login, index) => (
                              <div key={index} className={`p-3 border rounded-lg ${
                                login.status === 'failed' ? 'bg-red-50 border-red-200' : 'bg-gray-50'
                              }`} data-testid={`item-login-history-${index}`}>
                                <div className="flex items-center justify-between">
                                  <div>
                                    <p className="text-sm font-medium">{login.data}</p>
                                    <p className="text-xs text-gray-600">{login.dispositivo}</p>
                                    <p className="text-xs text-gray-500">{login.luogo}</p>
                                  </div>
                                  <Badge variant={login.status === 'failed' ? 'destructive' : 'secondary'}>
                                    {login.status === 'failed' ? 'Fallito' : 'Successo'}
                                  </Badge>
                                </div>
                              </div>
                            ))}
                      ...
                      <TabsContent value="notifications" className="space-y-6">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                          {/* Email Notifications */}
                          <Card className="p-6">
                            <h3 className="font-semibold mb-4">Notifiche Email</h3>
                            <div className="space-y-4">
                              {[
                                { tipo: 'Richieste HR', descrizione: 'Notifiche per nuove richieste e approvazioni', attivo: true },
                                { tipo: 'Performance Reviews', descrizione: 'Promemoria e aggiornamenti su valutazioni', attivo: true },
                                { tipo: 'Training', descrizione: 'Nuovi corsi e scadenze certificazioni', attivo: true },
                                { tipo: 'Timesheet', descrizione: 'Promemoria compilazione timesheet', attivo: false },
                                { tipo: 'Team Updates', descrizione: 'Aggiornamenti dal team e manager', attivo: true },
                                { tipo: 'System Maintenance', descrizione: 'Manutenzioni programmate del sistema', attivo: false }
                              ].map((notifica, index) => (
                                <div key={index} className="flex items-center justify-between p-3 border rounded-lg" data-testid={`item-email-notification-${index}`}>
                                  <div className="flex-1">
                                    <h4 className="text-sm font-medium">{notifica.tipo}</h4>
                                    <p className="text-xs text-gray-500">{notifica.descrizione}</p>
                                  </div>
                                  <Switch defaultChecked={notifica.attivo} data-testid={`switch-email-${index}`} />
                                </div>
                              ))}
                            </div>
                          </Card>
                          ...
                          {/* Push Notifications */}
                          <Card className="p-6">
                            <h3 className="font-semibold mb-4">Notifiche Push</h3>
                            <div className="space-y-4">
                              {[
                                { tipo: 'Messaggi Urgenti', descrizione: 'Notifiche immediate per messaggi prioritari', attivo: true },
                                { tipo: 'Approvazioni Richieste', descrizione: 'Quando una richiesta viene approvata/rifiutata', attivo: true },
                                { tipo: 'Meeting Reminders', descrizione: 'Promemoria 15 minuti prima delle riunioni', attivo: true },
                                { tipo: 'Deadline Alerts', descrizione: 'Avvisi per scadenze imminenti', attivo: true },
                                { tipo: 'Team Mentions', descrizione: 'Quando vieni menzionato nei team chat', attivo: false },
                                { tipo: 'Daily Digest', descrizione: 'Riepilogo giornaliero attività', attivo: false }
                              ].map((notifica, index) => (
                                <div key={index} className="flex items-center justify-between p-3 border rounded-lg" data-testid={`item-push-notification-${index}`}>
                                  <div className="flex-1">
                                    <h4 className="text-sm font-medium">{notifica.tipo}</h4>
                                    <p className="text-xs text-gray-500">{notifica.descrizione}</p>
                                  </div>
                                  <Switch defaultChecked={notifica.attivo} data-testid={`switch-push-${index}`} />
                                </div>
                              ))}
                            </div>
                          </Card>
                        ...
                        <Card className="p-6">
                          <h3 className="font-semibold mb-4">Orari Notifiche</h3>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-4">
                              <div>
                                <Label className="text-sm font-medium">Modalità Non Disturbare</Label>
                                <p className="text-xs text-gray-500 mb-3">Disattiva notifiche durante orari specifici</p>
                                <Switch data-testid="switch-do-not-disturb" />
                              </div>
                              
                              <div className="space-y-2">
                                <Label className="text-sm font-medium">Orario Inizio</Label>
                                <Input type="time" defaultValue="22:00" data-testid="input-dnd-start" />
                              </div>
                              
                              <div className="space-y-2">
                                <Label className="text-sm font-medium">Orario Fine</Label>
                                <Input type="time" defaultValue="08:00" data-testid="input-dnd-end" />
                              </div>
                            </div>
                            ...
                            <div className="space-y-4">
                              <div>
                                ...
                                <p className="text-xs text-gray-500 mb-3">Riduci notifiche nei weekend</p>
                                <Switch defaultChecked data-testid="switch-weekend-mode" />
                              </div>
                              
                              <div className="space-y-2">
                                <Label className="text-sm font-medium">Frequenza Digest</Label>
                      ...
                      <TabsContent value="privacy" className="space-y-6">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                          {/* Data Sharing */}
                          <Card className="p-6">
                            <h3 className="font-semibold mb-4">Condivisione Dati</h3>
                            <div className="space-y-4">
                              {[
                                { 
                                  tipo: 'Dati Performance', 
                                  descrizione: 'Condividi metriche performance con manager', 
                                  livello: 'manager',
                                  attivo: true 
                                },
                                { 
                                  tipo: 'Stato Presenza', 
                                  descrizione: 'Mostra status online/offline ai colleghi', 
                                  livello: 'team',
                                  attivo: true 
                                },
                                { 
                                  tipo: 'Training Progress', 
                                  descrizione: 'Condividi progressi formativi con HR', 
                                  livello: 'hr',
                                  attivo: true 
                                },
                                { 
                                  tipo: 'Contact Info', 
                                  descrizione: 'Rendi visibili contatti personali', 
                                  livello: 'limited',
                                  attivo: false 
                                },
                                { 
                                  tipo: 'Calendar Events', 
                                  descrizione: 'Condividi calendario con team', 
                                  livello: 'team',
                                  attivo: true 
                                }
                              ].map((privacy, index) => (
                                <div key={index} className="space-y-2" data-testid={`item-data-sharing-${index}`}>
                                  <div className="flex items-center justify-between">
                                    <div className="flex-1">
                                      <h4 className="text-sm font-medium">{privacy.tipo}</h4>
                                      <p className="text-xs text-gray-500">{privacy.descrizione}</p>
                                    </div>
                                    <Switch defaultChecked={privacy.attivo} data-testid={`switch-privacy-${index}`} />
                                  </div>
                                  <div className="ml-4">
                                    <Select defaultValue={privacy.livello}>
                                      <SelectTrigger className="w-32 h-8 text-xs" data-testid={`select-privacy-level-${index}`}>
                                        <SelectValue />
                                      </SelectTrigger>
                                      <SelectContent>
                                        <SelectItem value="public">Pubblico</SelectItem>
                                        <SelectItem value="team">Solo Team</SelectItem>
                                        <SelectItem value="manager">Solo Manager</SelectItem>
                                        <SelectItem value="hr">Solo HR</SelectItem>
                          ...
                          {/* Data Rights */}
                          <Card className="p-6">
                            <h3 className="font-semibold mb-4">Diritti sui Dati (GDPR)</h3>
                            <div className="space-y-4">
                              <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                <h4 className="text-sm font-medium text-blue-800 mb-2">I tuoi Diritti</h4>
                                <p className="text-xs text-blue-700">
                                  Hai diritto di accedere, correggere, cancellare o limitare il trattamento dei tuoi dati personali.
                                </p>
                              </div>
                              ...
                              <div className="space-y-3">
                                ...
                                <Button variant="outline" className="w-full justify-start" data-testid="button-data-correction">
                                  <Edit3 className="h-4 w-4 mr-2" />
                                  Richiedi Correzione Dati
                                </Button>
                                
                                <Button variant="outline" className="w-full justify-start" data-testid="button-limit-processing">
                                  <Shield className="h-4 w-4 mr-2" />
                                  Limita Trattamento
                                </Button>
                                
                                <Button variant="outline" className="w-full justify-start text-red-600 border-red-200" data-testid="button-delete-account">
                        ...
                        {/* Consent Management */}
                        <Card className="p-6">
                          <h3 className="font-semibold mb-4">Gestione Consensi</h3>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-4">
                              <h4 className="text-sm font-medium">Consensi Attivi</h4>
                              {[
                                { tipo: 'Trattamento Dati HR', data: '01/01/2024', obbligatorio: true },
                                { tipo: 'Comunicazioni Marketing', data: '15/03/2024', obbligatorio: false },
                                { tipo: 'Analytics e Performance', data: '01/01/2024', obbligatorio: true },
                                { tipo: 'Cookies Funzionali', data: '19/12/2024', obbligatorio: false }
                              ].map((consenso, index) => (
                                <div key={index} className="flex items-center justify-between p-3 border rounded-lg" data-testid={`item-consent-${index}`}>
                                  <div>
                                    <p className="text-sm font-medium">{consenso.tipo}</p>
                                    <p className="text-xs text-gray-500">Consenso dato: {consenso.data}</p>
                                    {consenso.obbligatorio && (
                                      <Badge variant="outline" className="text-xs mt-1">Obbligatorio</Badge>
                                    )}
                                  </div>
                                  {!consenso.obbligatorio && (
                                    <Button size="sm" variant="outline" data-testid={`button-revoke-consent-${index}`}>
                                      Revoca
                                    </Button>
                                  )}
                                </div>
                            ...
                            <div className="space-y-4">
                              <h4 className="text-sm font-medium">Impostazioni Cookie</h4>
                              <div className="space-y-3">
                                {[
                                  { tipo: 'Cookies Essenziali', descrizione: 'Necessari per il funzionamento', attivo: true, disabilitabile: false },
                                  { tipo: 'Cookies Performance', descrizione: 'Analytics e miglioramenti', attivo: true, disabilitabile: true },
                                  { tipo: 'Cookies Marketing', descrizione: 'Personalizzazione contenuti', attivo: false, disabilitabile: true },
                                  { tipo: 'Cookies Terze Parti', descrizione: 'Servizi esterni integrati', attivo: false, disabilitabile: true }
                                ].map((cookie, index) => (
                                  <div key={index} className="flex items-center justify-between" data-testid={`item-cookie-${index}`}>
                                    <div className="flex-1">
                                      <p className="text-sm font-medium">{cookie.tipo}</p>
                                      <p className="text-xs text-gray-500">{cookie.descrizione}</p>
                                    </div>
                                    <Switch 
                                      defaultChecked={cookie.attivo} 
                                      disabled={!cookie.disabilitabile}
                                      data-testid={`switch-cookie-${index}`}
                                    />
                                  </div>
                                ))}
                              </div>
