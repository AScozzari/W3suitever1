        ...
        <main style={{
          ...
          {currentModule === 'impostazioni' && (
            <div style={{ padding: '24px' }}>
              ...
              <div style={{ background: '#ffffff', borderRadius: '12px', border: '1px solid #e5e7eb', padding: '32px' }}>
                <h2 style={{ fontSize: '24px', fontWeight: '700', color: '#111827', marginBottom: '16px' }}>
                  Configurazione Enterprise
                </h2>
                <p style={{ color: '#6b7280', fontSize: '16px' }}>
                  Modulo impostazioni in sviluppo - qui verranno integrate tutte le configurazioni di sistema.
                </p>
              </div>
            </div>
          )}
