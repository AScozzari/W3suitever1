...
// 🗄️ W3SUITE DATA OPERATIONS
// Note: W3 Data nodes (like Database Operation) are now defined in workflow-node-definitions.ts
...
export const ALL_MCP_NODES = [
  ...MCP_OUTBOUND_NODES,
  ...MCP_INBOUND_NODES
  // W3SUITE_DATA_NODES removed - now in workflow-node-definitions.ts to avoid duplication
];
